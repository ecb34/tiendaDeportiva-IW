            ...
            <div>
                <div>
                    ...
                    <p class="ng-binding">La entidad responsable de la recogida, procesamiento y utilización de tus datos personales, en el sentido establecido por la Ley de Protección de Datos Personales es la página uasport.com, propiedad de UASport – Carr. de San Vicente del Raspeig, s/n, 03690 San Vicente del Raspeig, Alicante.</p>
                                ...
                                UASport) o bien cuando se borran manualmente. </p>  
                    <p></p>
                    ...
                    <p></p>
                    <h3><p class="ng-binding">Adicionalmente, en función de su objetivo, las cookies pueden clasificarse de la siguiente forma:</p></h3>
                    ...
                    <p class="ng-binding">Importante: Salvo que el usuario decida registrarse en un servicio de
                        UASport, la cookie nunca irá asociada a ningún dato de carácter personal que pueda identificarle. Dichas cookies sólo serán utilizadas con propósitos estadísticos que ayuden a la optimización de la experiencia de los usuarios en el sitio.</p>
