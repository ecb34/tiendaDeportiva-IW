    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card card-widget widget-user">
          ...
          <div class="widget-user-header text-white" style="background-image:url('./images/img(11).jpg'); background-size:cover; background-position:center; border-radius:20%;">
            ...
            <div class="widget-user-image text-center">
              <img class="img-circle border-right" style="border-radius:50%; margin-left:1%;" alt="User Avatar" src="images/noImagenPerfil.png">
                  ...
                  <h4 class="widget-user-email text-center" style="color:white; margin-left:1%;">Email: {{user.email}}</h4>
                  <h4 class="widget-user-email text-center" style="color:white; margin-left:1%;">Nacido el: {{user.fecha_nacimiento}}</h4>
          </div>
